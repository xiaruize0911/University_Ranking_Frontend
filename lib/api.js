...
export async function updateFavoriteCount(favoriteCount) {
    try {
        if (Platform.OS === 'web') {
            // Update localStorage for web
            const existingProfile = window.localStorage.getItem('userProfile');
            let profile = {
            ...
            if (existingProfile) {
                ...
                // Create default profile with favorite count
                profile = {
                    favoriteCount: favoriteCount,
